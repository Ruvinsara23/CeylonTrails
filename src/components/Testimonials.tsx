          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial, idx) => (
              <ScrollReveal key={testimonial.id} delay={idx * 0.1}>
                <div className={`bg-pearl-50 p-8 rounded-3xl border border-pearl-200 shadow-sm flex flex-col h-full ${idx === 0 ? 'md:col-span-2 lg:col-span-2 bg-forest-950 text-white' : ''}`}>
